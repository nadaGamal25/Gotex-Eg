...
export default function CreateAccountMarketer() {
  ...
  async function sendRegisterDataToApi() {
      try {
        const response = await axios.post(`https://dashboard.go-tex.net/eg-co-test/marketer/create-marketer-account`,theUser,
        {
            headers: {
  ...
  return (
    ...
    <div className="mt-3">
    <div className=" edit-form light-box p-5">
    ...
    {errorList.map((err,index)=>{
      ...
      <button className='btn btn-lightblue2'>
